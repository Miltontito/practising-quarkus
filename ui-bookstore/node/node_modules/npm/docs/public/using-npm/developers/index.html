...
<p><code class="language-text">.npmignore</code> files follow the <a href="https://git-scm.com/libro/en/v2/Git-Basics-Recording-Changes-to-the-Repository#Ignoring-Files">same pattern rules</a>
